...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.55-kirby-problem-3.55-1e011f9b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.55"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.55-kirby-problem-3.55-1e011f9b-v1",
      "problem_contract_sha256": "d5ce1e24b25d8fea509c6c1be269b15b4cd3fe867182142d3537017263d874b3",
      "problem_id": "problem:um-kp-3.55-kirby-problem-3.55-1e011f9b",
      "route_id": "route:um-kp-3.55-kirby-problem-3.55-1e011f9b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.55-kirby-problem-3.55-1e011f9b-source-fidelity-01",
      "graph_id": "graph:um-kp-3.55-kirby-problem-3.55-1e011f9b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.55-kirby-problem-3.55-1e011f9b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.55-kirby-problem-3.55-1e011f9b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) For $K$ a nontrivial knot in $S^3$, does $HFK^-(K)$ always admit an $\\mathbb{F}_2$-summand, as an $\\mathbb{F}_2[U]$-module? (b) For $Y$ a rational homology sphere, if $HF_{\\mathrm{red}}(Y)$ is nontrivial, does $HF_{\\mathrm{red}}(Y)$ always admit an $\\mathbb{F}_2$-summand?"
          },
          "statement_sha256": "0f36a960b301679184db93275df3573fac8cd70c137b689b7cc9d8483f061ad6"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.55-kirby-problem-3.55-1e011f9b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.55-kirby-problem-3.55-1e011f9b-root",
      "route_id": "route:um-kp-3.55-kirby-problem-3.55-1e011f9b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.55-dc4a56573855",
        "url": "https://www.unsolvedmath.com/problems/KP-3.55"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
